...
#ifndef PROTOBUF_protocol_2fcandidates_2eproto__INCLUDED
#define PROTOBUF_protocol_2fcandidates_2eproto__INCLUDED
...
class Annotation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.Annotation) */ {
 ...
 private:
  ...
  bool deletable_;
  friend void  protobuf_AddDesc_protocol_2fcandidates_2eproto();
  friend void protobuf_AssignDesc_protocol_2fcandidates_2eproto();
  friend void protobuf_ShutdownFile_protocol_2fcandidates_2eproto();
...
class Information : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.Information) */ {
 public:
  ...
  inline Information* New() const { return New(NULL); }

  Information* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class InformationList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.InformationList) */ {
 public:
  ...
  inline InformationList* New() const { return New(NULL); }

  InformationList* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class CandidateWord : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.CandidateWord) */ {
 public:
  ...
  inline CandidateWord* New() const { return New(NULL); }

  CandidateWord* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class CandidateList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.CandidateList) */ {
 public:
  ...
  inline CandidateList* New() const { return New(NULL); }

  CandidateList* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class Candidates_Candidate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.Candidates.Candidate) */ {
 public:
  ...
  inline Candidates_Candidate* New() const { return New(NULL); }

  Candidates_Candidate* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class Candidates : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.commands.Candidates) */ {
 public:
  ...
  inline Candidates* New() const { return New(NULL); }

  Candidates* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
template <> struct is_proto_enum< ::mozc::commands::Candidates_Direction> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::commands::Category> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mozc::commands::Category>() {
  return ::mozc::commands::Category_descriptor();
}
template <> struct is_proto_enum< ::mozc::commands::DisplayType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_protocol_2fcandidates_2eproto__INCLUDED
