...
#ifndef PROTOBUF_protocol_2fconfig_2eproto__INCLUDED
#define PROTOBUF_protocol_2fconfig_2eproto__INCLUDED
...
class GeneralConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.config.GeneralConfig) */ {
 public:
  ...
  inline GeneralConfig* New() const { return New(NULL); }

  GeneralConfig* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  friend void  protobuf_AddDesc_protocol_2fconfig_2eproto();
  friend void protobuf_AssignDesc_protocol_2fconfig_2eproto();
  friend void protobuf_ShutdownFile_protocol_2fconfig_2eproto();
...
class Config_CharacterFormRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.config.Config.CharacterFormRule) */ {
 public:
  ...
  inline Config_CharacterFormRule* New() const { return New(NULL); }

  Config_CharacterFormRule* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class Config_InformationListConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.config.Config.InformationListConfig) */ {
 public:
  ...
  inline Config_InformationListConfig* New() const { return New(NULL); }

  Config_InformationListConfig* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
template <> struct is_proto_enum< ::mozc::config::Config_PreeditMethod> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_SessionKeymap> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_PunctuationMethod> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_SymbolMethod> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_FundamentalCharacterForm> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_HistoryLearningLevel> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_SelectionShortcut> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_CharacterForm> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_ShiftKeyModeSwitch> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_NumpadCharacterForm> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_AutoConversionKey> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::mozc::config::Config_YenSignCharacter> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_protocol_2fconfig_2eproto__INCLUDED
