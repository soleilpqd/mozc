...
class Stats_DoubleValueStats : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.usage_stats.Stats.DoubleValueStats) */ {
 public:
  ...
  inline Stats_DoubleValueStats* New() const { return New(NULL); }

  Stats_DoubleValueStats* New(::google::protobuf::Arena* arena) const;
...
class Stats_TouchEventStats : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.usage_stats.Stats.TouchEventStats) */ {
 public:
  ...
  inline Stats_TouchEventStats* New() const { return New(NULL); }

  Stats_TouchEventStats* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class Stats_VirtualKeyboardStats : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mozc.usage_stats.Stats.VirtualKeyboardStats) */ {
 public:
  ...
  inline Stats_VirtualKeyboardStats* New() const { return New(NULL); }

  Stats_VirtualKeyboardStats* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
template <> struct is_proto_enum< ::mozc::usage_stats::Stats_Type> : ::google::protobuf::internal::true_type {};
template <>
